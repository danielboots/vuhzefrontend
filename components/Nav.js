...
export default function Example() {
  return (
    <div className="relative bg-gray-50 z-50 font-body ">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
              <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
                <div className="flex justify-start lg:w-0 lg:flex-1">
                  <a href="#">
                    <span className="sr-only">Vuhze</span>
                    <img
                ...
                <Popover.Group as="nav" className="hidden md:flex space-x-10">
                  ...
                  <a
                    href="#"
                    className="text-gray-900 font-bold uppercase hover:text-gray-900"
                  >
                    Pricing
                  </a>
                  <a
                ...
                <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                  <a
                    href="#"
                    className="whitespace-nowrap text-base font-bold text-gray-900 uppercase hover:text-gray-900"
                  >
                    Sign in
                  </a>
                  <a
                    href="#"
                    className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-bold uppercase text-white bg-indigo-600 hover:bg-indigo-700"
                  >
                    Sign up
                  </a>
                </div>
